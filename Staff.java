...
public abstract class Staff extends Thread
{
    ...
    public synchronized String getFinishTime()
    {
    ...
    public synchronized boolean clockOut()
    {
    ...
    public synchronized boolean changeStartTime(Date newStartTime)
    {
    ...
    public synchronized boolean changeFinishTime(Date newFinishTime)
    {
    ...
    public synchronized double culculateWorkTime()
    {
