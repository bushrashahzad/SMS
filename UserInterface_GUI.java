...
public class UserInterface_GUI extends JFrame implements ActionListener
{
    ...
    public UserInterface_GUI(Controller_GUI rController)
    {
        ...
        // Set frame
        setTitle("HyperPanda SuperMarket");
    ...
    private void createMasterPanelConpornents()
    {
        ...
        headTitle = new JLabel("HyperPanda SuperMarket");
    ...
    *****************************************************************/       
    private class MenuListPanel extends JPanel implements ActionListener
    {
        ...
        private JButton         btnElectronics;
        private JButton         btnBakeryItem;
        private JButton         btnCosmetics;
        ...
        public MenuListPanel()
        {
           ...
           btnBakeryItem = new JButton("BakeryItem");
           btnBakeryItem.addActionListener(this);
           btnCosmetics = new JButton("Cosmetics");
           btnCosmetics.addActionListener(this);
           
           btnPanel.add(btnAll);
           btnPanel.add(btnGrocery);
           btnPanel.add(btnElectronics);
           btnPanel.add(btnBakeryItem);
           btnPanel.add(btnCosmetics);
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            else if (ae.getSource() == btnGrocery)
            {
                showMenuList(MenuItem.Grocery);
                //showParticularMenuList(MenuItem.Grocery, displayArea);
            }
            else if (ae.getSource() == btnElectronics)
            {
                showMenuList(MenuItem.Electronics);
                //showParticularMenuList(MenuItem.Electronics, displayArea);
            }
            else if (ae.getSource() == btnBakeryItem)
            {
                showMenuList(MenuItem.BakeryItem);
                //showParticularMenuList(MenuItem.BakeryItem, displayArea);
            }
            else if (ae.getSource() == btnCosmetics)
            {
                showMenuList(MenuItem.Cosmetics);
                //showParticularMenuList(MenuItem.Cosmetics, displayArea);
            }
        }
    }
    ...
    *****************************************************************/       
    private class EditMenuItemPanel extends JPanel implements ActionListener
    {
        ...
        public EditMenuItemPanel()
        {
            ...
            String[] combodata = {"Grocery", "Electronics", "BakeryItem", "Cosmetics"};
        ...
        public void init(int menuItemID)
        {
            ...
            {
                case MenuItem.Grocery:
                    setType("Grocery");
                break;
                case MenuItem.Electronics:
                    setType("Electronics");
                break;
                case MenuItem.BakeryItem:
                    setType("BakeryItem");
                break;
                case MenuItem.Cosmetics:
                    setType("Cosmetics");
                break;
            }
        ...
        public void actionPerformed(ActionEvent ae) {
            if (ae.getSource() == btnOK)
            {
                ...
                if( strMenuType.equals("Grocery"))
                {
                    menuType = MenuItem.Grocery;
                }
                else if( strMenuType.equals("Electronics"))
                {
                    menuType = MenuItem.Electronics;
                }
                else if( strMenuType.equals("BakeryItem"))
                {
                    menuType = MenuItem.BakeryItem;
                }
                else    //Cosmetics
                {
                    menuType = MenuItem.Cosmetics;
                }
    ...
    *****************************************************************/       
    private class OrderDetailPanel extends JPanel implements ActionListener, ListSelectionListener
    {
        ...
        public OrderDetailPanel()
        {
            ...
            gbc.gridx = 1;
            gbc.gridy = 2;
            gbLayout.setConstraints(btnGrocery, gbc);
            menuListPanel.add(btnGrocery);
            
            btnElectronics  = new JButton("Electronics");
            btnElectronics.addActionListener(this);
            gbc.gridx = 2;
            gbc.gridy = 2;
            gbLayout.setConstraints(btnElectronics, gbc);
            menuListPanel.add(btnElectronics);
            
             btnBakeryItem  = new JButton("BakeryItem");
             btnBakeryItem.addActionListener(this);
            gbc.gridx = 3;
            gbc.gridy = 2;
            gbLayout.setConstraints(btnBakeryItem, gbc);
            menuListPanel.add(btnBakeryItem);
            
            btnCosmetics  = new JButton("Cosmetics");
            btnCosmetics.addActionListener(this);
            gbc.gridx = 4;
            gbc.gridy = 2;
            gbLayout.setConstraints(btnCosmetics, gbc);
            menuListPanel.add(btnCosmetics);
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            {
                //createParticularMenuList(MenuItem.Grocery, menuList);
                menuList.setListData(rcController.createMenuList(MenuItem.Grocery).toArray());
                menuScrollPanel.getViewport().setView(menuList);
            }
             else if (ae.getSource() == btnElectronics)
            {
                //createParticularMenuList(MenuItem.Electronics, menuList);
                menuList.setListData(rcController.createMenuList(MenuItem.Electronics).toArray());
                menuScrollPanel.getViewport().setView(menuList);
            }
             else if (ae.getSource() == btnBakeryItem)
            {
                //createParticularMenuList(MenuItem.BakeryItem, menuList);
                menuList.setListData(rcController.createMenuList(MenuItem.BakeryItem).toArray());
                menuScrollPanel.getViewport().setView(menuList);
            }
             else if (ae.getSource() == btnCosmetics)
            {
                //createParticularMenuList(MenuItem.Cosmetics, menuList);
                menuList.setListData(rcController.createMenuList(MenuItem.Cosmetics).toArray());
                menuScrollPanel.getViewport().setView(menuList);
            }
        }
